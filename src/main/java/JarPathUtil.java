...
public class JarPathUtil {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Enumeration<URL> en = classLoader1.getResources("org/apache/http/conn/ssl/SSLConnectionSocketFactory.class");
        System.out.println(classLoader1);

        //3.
        ClassLoader classLoader2 = ClassLoader.getSystemClassLoader().getParent();
        Enumeration<URL> en2 = classLoader2.getResources("org/apache/http/conn/ssl/SSLConnectionSocketFactory.class");
        System.out.println(classLoader2);

//        Enumeration<URL> en = Thread.class.getClassLoader().getResources("org/apache/http/conn/ssl/SSLConnectionSocketFactory.class");
